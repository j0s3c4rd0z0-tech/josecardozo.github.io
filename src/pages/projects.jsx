...
const projects = [
  ...
  {
    name: 'Boys Who Code TXST',
    description:
      "I've created the entire structure of our Boys Who Code chapter, including our website! It utilizes Stripe's API to accept donations that fund our events and activities.",
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Jose Cardozo</title>
        <meta
          name="description"
