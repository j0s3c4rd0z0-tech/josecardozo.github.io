  ...
  let resume = [
    {
      ...
      title: '– Site Reliability Engineer (SRE) & Integration Engineer',
      logo: amazonIcon,
      start: 'Dic 2018',
      end: 'Feb 2026',
    },
    {
      ...
      title: 'DBA - Systems Administrator & Lead Engineer',
      logo: halcyoncore,
      start: 'March 2017',
      end: 'Dic 2018',
    },
    ...
    },
    {
      ...
      title: 'Applications & Database Engineer',
      logo: logoGWC,
      start: 'Feb 2022',
      end: 'March 2017',
    },
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Leader, artist, and frontend enthusiast in Málaga, Spain.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Jose, a computer science student and Cloud & Infrastructure Engineer 
			with 12+ years of experience designing, operating, and automating mission-critical backend and 
			hybrid cloud platforms. Strong background in Kubernetes, Docker, VMware, OpenStack, CI/CD pipelines, and database 
			administration (Oracle, PostgreSQL, SQL Server). Focused on reliability, automation, security, and operational excellence. 
          </p>
          <div className="mt-6 flex gap-6">
            ...
            /> */}
            {/* <SocialLink
              href="https://twitter.com/cs__Jose"
